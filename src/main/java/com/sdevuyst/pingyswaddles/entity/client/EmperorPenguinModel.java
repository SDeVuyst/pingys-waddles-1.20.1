...
public class EmperorPenguinModel<T extends Entity> extends HierarchicalModel<T> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition bone = partdefinition.addOrReplaceChild("bone", CubeListBuilder.create().texOffs(0, 0).addBox(-6.0F, -20.0F, -8.0F, 16.0F, 20.0F, 16.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.0F, 24.0F, 0.0F, 0, 180, 0));

        PartDefinition top = bone.addOrReplaceChild("top", CubeListBuilder.create(), PartPose.offsetAndRotation(2.0F, -11.5F, 0.0F, -0.0349F, 0.0F, 0.0F));
        ...
        PartDefinition wings = bone.addOrReplaceChild("wings", CubeListBuilder.create(), PartPose.offset(2.0F, -1.5F, 0.0F));
        ...
        PartDefinition feet = bone.addOrReplaceChild("feet", CubeListBuilder.create(), PartPose.offset(2.0F, -2.0F, 0.0F));
        ...
        PartDefinition tail = bone.addOrReplaceChild("tail", CubeListBuilder.create(), PartPose.offset(8.25F, -1.75F, 0.75F));
